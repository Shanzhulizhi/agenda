...
func init() {
	...
	infolog = getLogFile("/src/github.com/shanzhulizhi/agenda/data/info.log")
	errlog = getLogFile("/src/github.com/shanzhulizhi/agenda/data/error.log")
...
func GetGOPATH() *string {
	...
	for _, v := range goPath {
		if _, err := os.Stat(filepath.Join(v, "/src/github.com/shanzhulizhi/agenda/data/meetinginfo")); !os.IsNotExist(err) {
			return &v
		}
	}
	return nil
