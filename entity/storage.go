...
import (
	...
	"github.com/shanzhulizhi/agenda/deepcopy"
)

type UserFilter func (*User) bool

var userinfoPath = "/src/github.com/shanzhulizhi/agenda/data/userinfo"
var curUserPath = "/src/github.com/shanzhulizhi/agenda/data/curuser.txt"
